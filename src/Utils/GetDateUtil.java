...
public class GetDateUtil {
	...
	public static String getdate1(){
		...
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS");//设置显示格式2014-12-26 09:10:33
 ...
 public static String getdateAfter5Min(){
	...
	public static long getdateS(){
		...
		//long millis= System.currentTimeMillis()/1000+2082873600;
		long millis= System.currentTimeMillis()/1000+2082844800;
		return millis;
	}
	//得到本月的第一天
 ...
 public static void main(String args[]) throws ParseException {
	...
	System.out.println(  GetDate.getdateMMSS());
	 ...
	 System.out.println(GetDateUtil.getdateNow());
 }
